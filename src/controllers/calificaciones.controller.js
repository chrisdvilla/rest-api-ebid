...
export const createCalificacion = async (req, res) => {
  ...
  try { 
    ...
    "INSERT INTO calificaciones (asistencia, gestion, id_alumno, id_materia, nota1, nota2, nota3, nota4, notaFinal, nota_literal, obs, segundoT) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)",
    [
        asistencia,
        gestion,
        id_alumno,
